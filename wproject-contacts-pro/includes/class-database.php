...
class WProject_Contacts_Database {
    ...
    public static function create_tables() {
        ...
        $sql_companies = "CREATE TABLE {$wpdb->prefix}wproject_companies (
            ...
            company_abn varchar(50) DEFAULT NULL,
            ...
            comm_slack varchar(255) DEFAULT NULL,
            comm_teams varchar(255) DEFAULT NULL,
            comm_google_meet varchar(255) DEFAULT NULL,
            comm_skype varchar(255) DEFAULT NULL,
            comm_other varchar(255) DEFAULT NULL,
            ...
            social_other varchar(500) DEFAULT NULL,
